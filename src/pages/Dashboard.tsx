    ...
    <div className="min-h-screen py-12 px-4">
      <div className="container mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card className="rounded-2xl shadow-md hover-scale cursor-pointer" onClick={() => navigate('/products')}>
            <CardHeader>
          ...
          <Card className="rounded-2xl shadow-md hover-scale cursor-pointer" onClick={() => navigate('/admin')}>
            <CardHeader>
              <CardTitle className="text-secondary flex items-center">
